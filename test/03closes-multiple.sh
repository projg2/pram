#!/bin/sh
# Test whether adding multiple closes refs work.
...
bash "${INITDIR}"/../pram -e true -G -I -S -c 314152 -c 314156 -c 314154 ./trivial.patch
...
diff -u - git-log.txt <<-EOF
	...
	Closes: https://bugs.gentoo.org/314156
