#!/bin/sh
# Test whether combining bug and closed refs work.
...
bash "${INITDIR}"/../pram -e true -G -I -S -c 314152 -b 314156 -b 314154 ./trivial.patch
...
diff -u - git-log.txt <<-EOF
	...
	Bug: https://bugs.gentoo.org/314154
